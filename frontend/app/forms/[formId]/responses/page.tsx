                    ...
                    return(
                      <div className={cn("border-2 rounded-xl p-5 transition-all",isActive?"border-gray-900 bg-gray-50":isError?"border-red-200 bg-red-50":"border-gray-200 bg-white hover:border-gray-300")}>
                        ...
                        {isActive&&notion?.config?.databaseTitle&&(
                          <div className="mb-3 text-xs text-gray-600 bg-white border border-gray-200 rounded-lg px-3 py-2 flex items-center gap-1.5"><img src="https://res.cloudinary.com/dci6nuwrm/image/upload/v1773051092/icons8-notion-64_gb39hv.png" alt="" className="w-4 h-4"/><span className="truncate">{notion.config.databaseTitle}</span></div>
                        )}
                        ...
                        {isActive||isError?(
                          ...
                          <Button className="w-full bg-gray-900 hover:bg-gray-800 text-white h-9 text-xs font-medium gap-2" disabled={connecting==="notion"} onClick={()=>handleConnect("notion")}>
                            {connecting==="notion"?<><Loader2 className="w-3.5 h-3.5 animate-spin"/>Connecting…</>:<><img src="https://res.cloudinary.com/dci6nuwrm/image/upload/v1773051092/icons8-notion-64_gb39hv.png" alt="" className="w-4 h-4"/>Connect Notion</>}
                          </Button>
                        )}
                      </div>
                    );
                      ...
                      <div className={cn("border-2 rounded-xl p-5 transition-all",isActive?"border-green-600 bg-green-50/50":isError?"border-red-200 bg-red-50":"border-gray-200 bg-white hover:border-gray-300")}>
                        ...
                        {isActive&&gs?.config?.spreadsheetUrl&&(
                          <a href={gs.config.spreadsheetUrl} target="_blank" className="mb-3 flex items-center gap-1.5 text-xs text-green-700 bg-white border border-green-200 rounded-lg px-3 py-2 hover:bg-green-50 transition-colors">
                            <img src="https://res.cloudinary.com/dci6nuwrm/image/upload/v1773051290/icons8-google-sheets-48_gcqjeh.png" alt="" className="w-4 h-4"/>Open spreadsheet<ExternalLink className="w-3 h-3 ml-auto shrink-0"/>
                          </a>
                        )}
                        ...
                        {isActive||isError?(
                          ...
                          <Button className="w-full bg-green-600 hover:bg-green-700 text-white h-9 text-xs font-medium gap-2" disabled={connecting==="sheets"} onClick={()=>handleConnect("sheets")}>
                            {connecting==="sheets"?<><Loader2 className="w-3.5 h-3.5 animate-spin"/>Connecting…</>:<><img src="https://res.cloudinary.com/dci6nuwrm/image/upload/v1773051290/icons8-google-sheets-48_gcqjeh.png" alt="" className="w-4 h-4"/>Connect Google Sheets</>}
                          </Button>
                        )}
                      </div>
                    );
