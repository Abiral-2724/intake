...
export default function TestimonialsSection() {
  ...
  const testimonials = [
    {
      quote:
        "Intake's AI assistant generated our entire event registration form in under 30 seconds. What used to take our team an afternoon now takes a minute — and the forms actually look great.",
      name: "Priya Nair",
      company: "Head of Events, Meridian Labs",
      image:
    ...
    {
      quote:
        "We switched from another form builder that charged us per response. Intake gives us unlimited submissions for free — and the Notion integration means our team sees new responses the moment they come in.",
      name: "Daniel Owusu",
      company: "Product Manager, Stackform",
      image:
    ...
    {
      quote:
        "The Smart Insights feature is genuinely impressive. I asked it to summarise 400 customer survey responses and it gave me a clear breakdown with sentiment analysis in seconds. Our old process took days.",
      name: "Camille Bertrand",
      company: "CX Lead, Lumio",
      image:
