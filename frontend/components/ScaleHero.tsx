        ...
        <div className="grid grid-cols-12 gap-5 gap-y-16">
          ...
          <div className="col-span-12 md:col-span-6 relative z-10">
            ...
            <h2
              ...
              style={{ fontFamily: "var(--font-figtree), Figtree", fontWeight: "400", fontSize: "40px" }}
            >
              Powerful enough for enterprises,{" "}
              <span className="opacity-40" style={{ fontWeight: "400", fontSize: "40px" }}>
                simple enough for anyone to use on day one.
              </span>
            </h2>
            ...
            >
              Intake combines a dead-simple block editor with Gemini AI, real-time analytics, and deep
              integrations — so your team can collect data, understand it, and act on it without leaving
              the platform.
            </p>
              ...
              <div className="grid grid-cols-12 gap-5 relative z-10">
                {stats.map((stat, index) => (
                  <div key={index} className="col-span-6 md:col-span-3">
                    ...
                    >
                      <span className="text-2xl font-medium leading-[26.4px] tracking-tight" style={{ color: "#146e96" }}>
                        {stat.value}
                      </span>
